...
public class EVMService
{
    ...
    const string rpc = "https://polygon-mainnet.g.alchemy.com/v2/YK2vDo3Ieko9YEI1xldJmTmRkVPk7bmp";
    const string chain = "polygon";
    const string network = "mainnet";
    const string contract = "0x48856571Cf9e625251542266E147C36d08645a65";
    const string nftContract = "0x158B808CB4C585017b6276e9D2753350e67363EC";
